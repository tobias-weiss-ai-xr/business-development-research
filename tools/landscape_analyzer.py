#!/usr/bin/env python3
"""Full landscape analysis of the business development research corpus.
...
def analyze(papers):
    ...
    theme_kw = [
        ...
        "agent", "agentic", "ai adoption", "automation", "digital transformation",
        "sme", "small business", "subscription", "saas", "platform", "marketplace",
        "churn", "retention", "acquisition", "unit economics", "lifetime value",
        "b2b", "lead generation", "funnel", "content", "seo", "brand",
        "positioning", "pricing", "freemium", "personalization", "recommend",
        "social media", "influencer", "word of mouth", "referral", "partnership",
        "negotiation", "persuasion", "behavioral", "nudge", "trust",
        "product-market fit", "mvp", "startup", "ab test", "conversion",
        "customer success", "upsell", "eu ai act", "ai literacy", "training",
    ]
    recent_text = Counter()
    all_text = Counter()
...
def render_markdown(res):
    L = []
    L.append("# Business Development Paper Landscape Report")
    L.append("")
