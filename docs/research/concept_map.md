...
| Concept | Kind | Papers |
|----------|------|--------|
| Ai Adoption | taxonomy | 778 |
| framework | curated | 727 |
...
- framework — 197 shared paper(s)
- survey — 66 shared paper(s)
- qualitative — 54 shared paper(s)
- dataset — 46 shared paper(s)
...
- Ai Adoption — 46 shared paper(s)
- framework — 41 shared paper(s)
- benchmark — 22 shared paper(s)
