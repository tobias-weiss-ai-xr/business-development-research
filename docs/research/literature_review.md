...
- [2026-08] Digital and non-digital marketing innovations — https://doi.org/10.17632/hmcjszvgzm.1
- [2026-08] Next-Generation Marketing in Global Medical Tourism with Augmented, Virtual, and Mixed Reality Techn — https://doi.org/10.5281/zenodo.18155244
- [2026-08] PRICE TRANSMISSION MECHANISM IN MULTI-TIER AGRICULTURAL MARKETS IN INDIA — https://doi.org/10.5281/zenodo.20996830

---

### Market Analysis & Research (`market-analysis`)

Market analysis research centers on segmentation, sizing and preference measurement (conjoint, willingness-to-pay); survey-based studies remain the dominant method, with ML-driven segmentation emerging.

**Corpus size:** 384 papers
...
**Corpus size:** 359 papers

**Recent papers:**

- [2026-08] Market Entry Strategy for 'Branded Calling' in Japan — https://doi.org/10.5281/zenodo.21827838
- [2026-08] Report on the finalised IMPAC3T-IP toolbox — https://doi.org/10.5281/zenodo.18403498
- [2026-08] Decoding complex gold mineralization in the Pitangui Greenstone Belt, Brazil: overprinting systems r — https://oro.open.ac.uk/view/person/if2375.html>;
...
### Sales Strategy & Process (`sales-strategy`)

Sales research covers forecasting, performance and account management. Recent work increasingly models sales processes with ML — a gap between academic forecasting and practitioner playbooks.
...
### Business Models & Innovation (`business-models`)

Business model research covers platform economics, network effects and subscription innovations. Two-sided market theory is the strongest theoretical anchor; AI-as-a-service models are the emerging cell.

**Corpus size:** 253 papers

**Recent papers:**

- [2026-07] The Price of Quietness: How a Pandemic Affects City Dwellers' Response to Road Traffic Noise — https://arxiv.org/abs/2607.18677v1
- [2026-06] Co-evolution of the global research collaboration network and the performance of nations in science  — https://arxiv.org/abs/2606.18549v1
- [2026-01] The Widening Profitability Gap between Renewable and Fossil Power Firms in Europe — https://arxiv.org/abs/2601.22167v1

---

### Product-Market Fit & Validation (`product-market-fit`)
...
### B2B Marketing & Lead Gen (`b2b-marketing`)
...
- [2026-08] Revisiting Supply Chain Resilience Under Emergent Business Landscapes — https://doi.org/10.17638/03191107
- [2026-08] CROCUS_WP4_AAU_Surveys of businesses_19-01-2026 — https://doi.org/10.5281/zenodo.18300213
- [2026-08] Development of an Advanced Artificial Intelligence-based Model (Deep Business Analytics) for Managin — https://doi.org/10.17638/03194278
...
Customer success research connects satisfaction, NPS and expansion revenue; AI support automation (chatbots, copilots) is the emerging application frontier.

**Corpus size:** 208 papers

**Recent papers:**

- [2026-07] Sharing economy in the era of full automation: Evidence from autonomous vehicle on-demand mobility s — https://arxiv.org/abs/2607.08610v1
- [2026-06] Empathy and the Human-Moment Gaps of AI Chatbots: Insights from Empathy Displacement Theory — https://arxiv.org/abs/2607.24775v1
- [2026-02] An Analytical Study on the Role of Satisfaction in Mediating Customer Loyalty and AI-Powered Digital — https://doi.org/10.32479/irmm.22326

---

### Growth Metrics & Analytics (`growth-metrics`)

Growth metrics research is measurement-heavy: unit economics, LTV, cohort analysis and A/B testing. The evidence base for subscription SaaS metrics is mature and directly transferable to training businesses.

**Corpus size:** 207 papers

**Recent papers:**

- [2026-08] Can AI Agents Simulate A/B Test Outcomes? A Validation Framework for Agentic Experimentation — https://arxiv.org/abs/2608.02345v1
- [2026-07] Customer Lifetime Value, Trust, and Loyalty Optimization — https://doi.org/10.4018/979-8-2600-0497-5.ch001
- [2026-07] TWICE: Two-Clock, Two-Window Learning for Long-Horizon Conversion Prediction in Online Advertising — https://arxiv.org/abs/2607.25404v1

---

### Partnerships & Alliances (`partnerships`)

Partnership research covers alliances, joint ventures and ecosystems. Coopetition and channel strategy are active themes; affiliate and co-marketing evidence is directly actionable for solo operators.

**Corpus size:** 205 papers

**Recent papers:**

- [2026-03] Climate policy uncertainty and climate-related strategic alliances — https://doi.org/10.1016/j.jbankfin.2026.107686
- [2026-03] Turning Trust to Transactions: Tracking Affiliate Marketing and FTC Compliance in YouTube's Influenc — https://arxiv.org/abs/2603.04383v2
- [2026-01] Mobility-as-a-service (MaaS) system as a multi-leader-multi-follower game: A single-level variationa — https://arxiv.org/abs/2601.19880v1

---

### Customer Acquisition & Growth (`customer-acquisition`)

Acquisition research quantifies CAC, referral mechanics and viral growth. Free-trial and freemium evidence shows conversion depends on activation speed more than feature depth.

**Corpus size:** 203 papers

**Recent papers:**

- [2026-06] Customer Acquisition, Business Dynamism, and Aggregate Growth — https://doi.org/10.1093/restud/rdag060
- [2026-05] Customer Acquisition, Business Dynamism and Aggregate Growth — https://doi.org/10.5281/zenodo.20048287
- [2026-05] Customer Acquisition Strategy and Performance of Motor Vehicle Assemblers in Kenya — https://doi.org/10.53819/81018102t4384

---

### Competitive Intelligence (`competitive-intelligence`)

Competitive intelligence research is grounded in competitive advantage theory (Porter) plus modern monitoring methods. Differentiation and positioning evidence for small firms favors focus strategies.

**Corpus size:** 202 papers
