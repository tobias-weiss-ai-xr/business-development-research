...
CATEGORY_ORDER = [
    "market-analysis", "go-to-market", "sales-strategy", "b2b-marketing",
    "content-marketing", "digital-marketing", "brand-building",
    "customer-acquisition", "customer-retention", "customer-success",
    "pricing-strategy", "product-market-fit", "business-models",
    "competitive-intelligence", "partnerships", "sales-psychology",
    "networking", "entrepreneurship", "growth-metrics", "ai-adoption",
]
...
def plot_category_distribution(papers):
    ...
    ax.set_title("Business Development Research Papers by Category", fontsize=14)
...
def plot_top_categories(papers):
    ...
    ax.set_title("Top 10 Business Development Research Categories", fontsize=14)
