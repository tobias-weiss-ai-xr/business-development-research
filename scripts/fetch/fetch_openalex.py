#!/usr/bin/env python3
"""Discover business development research papers from the OpenAlex API (fallback/primary source).
...
def main():
    parser = argparse.ArgumentParser(description="Discover business development research papers from OpenAlex")
