...
QUERIES = [
    ...
    ('cat:cs.CY AND abs:"AI" AND abs:"upskilling"', 'ai-adoption', 'method'),
    ('cat:cs.CY AND abs:"AI" AND abs:"reskilling"', 'ai-adoption', 'method'),
    ('cat:cs.CY AND abs:"AI training" AND abs:"workplace"', 'ai-adoption', 'application'),
    ('cat:cs.CY AND abs:"employees" AND abs:"AI skills"', 'ai-adoption', 'application'),
    ('cat:cs.CY AND abs:"AI" AND abs:"workforce development"', 'ai-adoption', 'method'),
    ('cat:cs.CY AND abs:"generative AI" AND abs:"worker" AND abs:"training"', 'ai-adoption', 'application'),
    ('cat:cs.CY AND abs:"future of work" AND abs:"skills" AND abs:"AI"', 'ai-adoption', 'mechanism'),
    ('cat:cs.CY AND abs:"AI" AND abs:"talent development"', 'ai-adoption', 'application'),
    ('cat:cs.CY AND abs:"AI literacy" AND abs:"organization"', 'ai-adoption', 'mechanism'),
    ('cat:cs.CY AND abs:"AI adoption" AND abs:"training" AND abs:"firm"', 'ai-adoption', 'application'),
    ('cat:cs.CY AND abs:"AI" AND abs:"implementation" AND abs:"change management"', 'ai-adoption', 'method'),
    ('cat:cs.CY AND abs:"AI readiness" AND abs:"organization"', 'ai-adoption', 'method'),
    ('cat:cs.CY AND abs:"AI" AND abs:"organizational learning"', 'ai-adoption', 'mechanism'),
    ('cat:cs.CY AND abs:"AI literacy" AND abs:"enterprise"', 'ai-adoption', 'application'),
    ('cat:cs.CY AND abs:"AI" AND abs:"capability building" AND abs:"firm"', 'ai-adoption', 'method'),
    ('cat:cs.CY AND abs:"AI transformation" AND abs:"workforce"', 'ai-adoption', 'mechanism'),
    ('cat:cs.CY AND abs:"AI" AND abs:"SME" AND abs:"training"', 'ai-adoption', 'application'),
    ('cat:cs.CY AND abs:"small and medium" AND abs:"digital skills"', 'ai-adoption', 'application'),
    ('cat:cs.CY AND abs:"SME" AND abs:"AI adoption" AND abs:"skills"', 'ai-adoption', 'mechanism'),
    ('cat:cs.CY AND abs:"small business" AND abs:"AI education"', 'ai-adoption', 'application'),
    ('cat:cs.CY AND abs:"SME" AND abs:"digital transformation" AND abs:"competence"', 'ai-adoption', 'application'),
    ('cat:cs.CY AND abs:"micro-enterprise" AND abs:"AI"', 'ai-adoption', 'application'),
    ('cat:cs.CY AND abs:"SME" AND abs:"training needs"', 'ai-adoption', 'method'),
    ('cat:cs.CY AND abs:"SME" AND abs:"AI" AND abs:"barriers"', 'ai-adoption', 'mechanism'),
    ('cat:cs.CY AND abs:"prompt engineering"', 'ai-adoption', 'method'),
    ('cat:cs.CY AND abs:"prompting" AND abs:"skills"', 'ai-adoption', 'method'),
    ('cat:cs.CY AND abs:"LLM" AND abs:"competence"', 'ai-adoption', 'mechanism'),
    ('cat:cs.CY AND abs:"generative AI" AND abs:"skills" AND abs:"workplace"', 'ai-adoption', 'application'),
    ('cat:cs.CY AND abs:"chatgpt" AND abs:"competence"', 'ai-adoption', 'mechanism'),
    ('cat:cs.CY AND abs:"generative AI literacy"', 'ai-adoption', 'theory'),
    ('cat:cs.CY AND abs:"AI tools" AND abs:"work tasks"', 'ai-adoption', 'application'),
    ('cat:cs.CY AND abs:"LLM reliance"', 'ai-adoption', 'mechanism'),
    ('cat:cs.CY AND abs:"AI" AND abs:"self-efficacy"', 'ai-adoption', 'mechanism'),
    ('cat:cs.CY AND abs:"technology acceptance" AND abs:"AI"', 'ai-adoption', 'mechanism'),
    ('cat:cs.CY AND abs:"AI acceptance" AND abs:"employees"', 'ai-adoption', 'mechanism'),
    ('cat:cs.CY AND abs:"trust" AND abs:"AI" AND abs:"users"', 'ai-adoption', 'mechanism'),
    ('cat:cs.CY AND abs:"attitudes toward AI"', 'ai-adoption', 'mechanism'),
    ('cat:cs.CY AND abs:"AI anxiety"', 'ai-adoption', 'mechanism'),
    ('cat:cs.CY AND abs:"AI" AND abs:"motivation" AND abs:"training"', 'ai-adoption', 'mechanism'),
    ('cat:cs.CY AND abs:"expectation" AND abs:"AI adoption"', 'ai-adoption', 'mechanism'),
    ('cat:cs.CY AND abs:"AI adoption" AND abs:"behavior"', 'ai-adoption', 'mechanism'),
    ('cat:cs.CY AND abs:"AI usage" AND abs:"employees"', 'ai-adoption', 'application'),
    ('cat:cs.CY AND abs:"AI" AND abs:"persona" AND abs:"adoption"', 'ai-adoption', 'method'),
    ('cat:cs.CY AND abs:"AI" AND abs:"engagement" AND abs:"training"', 'ai-adoption', 'evaluation'),
    ('cat:cs.CY AND abs:"generative AI" AND abs:"use patterns"', 'ai-adoption', 'mechanism'),
    ('cat:cs.CY AND abs:"AI tool adoption" AND abs:"workers"', 'ai-adoption', 'application'),
    ('cat:cs.CY AND abs:"digital literacy" AND abs:"AI" AND abs:"practice"', 'ai-adoption', 'application'),
    ('cat:cs.CY AND abs:"AI" AND abs:"behavioral intention"', 'ai-adoption', 'mechanism'),
    ('cat:cs.CY AND abs:"AI" AND abs:"upskilling" AND abs:"review"', 'ai-adoption', 'review'),
    ('cat:cs.CY AND abs:"prompt engineering" AND abs:"survey"', 'ai-adoption', 'review'),
    ('cat:cs.CY AND abs:"technology acceptance" AND abs:"AI" AND abs:"review"', 'ai-adoption', 'review'),
    ('cat:cs.CY AND abs:"AI" AND abs:"SME" AND abs:"review"', 'ai-adoption', 'review'),
    ('cat:cs.CY AND abs:"workforce" AND abs:"AI" AND abs:"review"', 'ai-adoption', 'review'),
    ('cat:cs.CY AND abs:"training effectiveness" AND abs:"AI"', 'ai-adoption', 'evaluation'),
    ('cat:cs.CY AND abs:"AI course" AND abs:"learning outcomes"', 'ai-adoption', 'evaluation'),
    ('cat:cs.CY AND abs:"AI training" AND abs:"productivity"', 'ai-adoption', 'evaluation'),
    ('cat:cs.CY AND abs:"AI adoption" AND abs:"productivity" AND abs:"firm"', 'ai-adoption', 'evaluation'),
    ('cat:cs.CY AND abs:"training" AND abs:"firm performance" AND abs:"AI"', 'ai-adoption', 'evaluation'),
    ('cat:cs.CY AND abs:"AI" AND abs:"labor productivity"', 'ai-adoption', 'evaluation'),
]
