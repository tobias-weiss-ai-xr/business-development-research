...
BURST_KEYWORDS = [
    "agentic", "agent", "generative ai", "genai", "large language model", "llm",
    "chatgpt", "artificial intelligence", "ai adoption", "automation",
    "sme", "small business", "solo", "freelance", "subscription", "saas",
    "alasa", "as-a-service", "platform", "marketplace", "churn", "retention",
    "acquisition", "unit economics", "lifetime value", "cohort", "kpi",
    "b2b", "lead generation", "funnel", "inbound", "content", "seo",
    "brand", "positioning", "pricing", "freemium", "dynamic pricing",
    "personalization", "recommendation", "social media", "influencer",
    "word of mouth", "referral", "network effect", "partnership", "alliance",
    "negotiation", "persuasion", "behavioral", "nudge", "trust",
    "digital transformation", "product-market fit", "mvp", "startup",
    "venture", "benchmark", "ab test", "conversion", "customer success",
    "upsell", "eu ai act", "regulation", "literacy", "skills", "training",
]
...
def main():
    ...
    with open(os.path.join(BASE, "assets", "business_analysis.json"), "w", encoding="utf-8") as f:
        json.dump(viz, f, indent=1)
    print("Wrote assets/business_analysis.json")
